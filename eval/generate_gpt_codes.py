...
if __name__ == "__main__":
    ...
    parser.add_argument("-t","--test_loc", default="~/apps/data_split/test.json", type=os.path.expanduser)
    parser.add_argument("-r","--root", default="~/apps/", type=os.path.expanduser, help="where the data is stored.")
    parser.add_argument("-l","--load", default="~/apps/checkpoints/final", type=os.path.expanduser)
    ...
    parser.add_argument("--save", type=os.path.expanduser, default="~/apps/results")
