...
if __name__ == "__main__":
    ...
    parser.add_argument("-t","--test_loc", default="~/apps/data_split/test.json", type=os.path.expanduser, help="path to the json containing problem paths to be evaluated.")
    parser.add_argument("-r","--root", default="~/apps/", type=os.path.expanduser, help="where the data is stored.")
    ...
    parser.add_argument("--save", type=os.path.expanduser, default="~/apps/results", help="Where the evaluated data is loaded from and results saved to.")
